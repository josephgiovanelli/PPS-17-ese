...
import it.unibo.pps.ese.model.genetics.dna.{Chromosome, ChromosomeCouple, ChromosomeType, GeneInChromosome, GeneWithAllelicForms, MGene, StructuralGene}
import it.unibo.pps.ese.model.genetics.dnaexpression.{AllelicGeneStats, BasicGeneStats, GeneStats}
import it.unibo.pps.ese.model.genetics.entities.{Animal, AnimalInfo, Carnivorous, Female, Herbivore, Male, Plant, QualityType}
