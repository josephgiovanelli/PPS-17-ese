...
import it.unibo.pps.ese.model.genetics.dna.{AnimalGenome, BasicGene, ChromosomeType, GeneWithAllelicForms, MGene}
import it.unibo.pps.ese.model.genetics.entities.QualityType.{Fecundity, Fertility, Life, Speed}
import org.scalatest.FunSuite
import it.unibo.pps.ese.model.genetics.entities._
import it.unibo.pps.ese.model.genetics.generators.SpeciesUtilities
import it.unibo.pps.ese.model.genetics.generators.data.{InputDataAdapter, TranslatedAnimalData}
