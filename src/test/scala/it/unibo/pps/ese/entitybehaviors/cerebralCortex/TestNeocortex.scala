...
class TestNeocortex extends FunSuite {
  test("Test neocortex") {
    ...
    neocortex.addMemory(MemoryType.Hunting, LongTermMemory(LocationalField(Position(0,20)), 150))
    neocortex.addMemory(MemoryType.Hunting, LongTermMemory(LocationalField(Position(10,30)), 160))
    neocortex.addMemory(MemoryType.Reproduction, LongTermMemory(LocationalField(Position(100,130)), 260))
