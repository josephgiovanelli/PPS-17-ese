...
import it.unibo.pps.ese.genericworld.model.WorldBuilder.{initializeBaseInfoComponent, initializeBrainComponent, initializePhysicalComponent, initializeReproductionComponent}
