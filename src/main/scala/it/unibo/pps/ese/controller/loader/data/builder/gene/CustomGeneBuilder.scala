...
import it.unibo.pps.ese.controller.loader.data.{CustomGeneData, PartialAlleleData}
...
import it.unibo.pps.ese.controller.loader.data.builder.gene.DefaultGeneBuilder.DefaultGeneDataImpl
