...
import it.unibo.pps.ese.controller.loader
import it.unibo.pps.ese.controller.loader.data.DefaultGeneData.{CompleteDefaultGeneData, PartialDefaultGeneData}
import it.unibo.pps.ese.controller.loader.data.{DefaultGeneData, PartialAlleleData}
...
import it.unibo.pps.ese.controller.loader.data.builder.gene.GeneStatus.{DefaultGene, DefaultGeneTemplate, EmptyGene, ValidGene}
...
trait DefaultGeneBuilder[S <: GeneStatus] extends BuildableGeneBuilder[S, DefaultGene, PartialDefaultGeneData, CompleteDefaultGeneData] {
  ...
  def setDefaultInfo(defaultGene: it.unibo.pps.ese.controller.loader.DefaultGene): DefaultGeneBuilder[S with DefaultGeneTemplate]
}
