...
/**
  * Interface used by the ReplayController to communicate the replay data
  */
trait ReplayView {

  /**
    * Draw a world based on the replay data
...
/**
  * Pane used to visualize graphically the chosen entity and those who interacted with it during its life
  */
