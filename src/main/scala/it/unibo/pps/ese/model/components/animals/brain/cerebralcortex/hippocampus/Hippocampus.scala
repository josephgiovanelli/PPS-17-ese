...
import it.unibo.pps.ese.model.components.animals.brain.cerebralcortex.hippocampus.Hippocampus.SearchingState.SearchingState
import it.unibo.pps.ese.model.components.animals.brain.cerebralcortex.{Memory => _, _}
